"""
Generate predictions for validation.csv (the 12,000 loads requiring final
predictions) using the final model trained on the full Jan-Oct dataset using XGBoost

Loads the saved model + artifacts, runs validation.csv through the SAME
