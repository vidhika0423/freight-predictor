"""
Final retraining on the full dataset.

The Jan-Aug/Sep-Oct split was only for HONEST TESTING during development. 
Now that XGBoost's hyperparameters and approach are validated, we retrain on
...
FINAL_XGB_PARAMS = dict(
    n_estimators=141,          # best_iteration found via early stopping 
    learning_rate=0.03,
    max_depth=4,
    min_child_weight=5,
    subsample=0.8,
